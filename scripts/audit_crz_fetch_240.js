#!/usr/bin/env node
// Audit DV-CRZ-SUMS batch 240: fetch CRZ detail pages, parse max amount, compare to DB.
const fs = require('fs');
const path = require('path');

const BATCH = path.join(__dirname, '..', '.audit', 'DV-CRZ-SUMS_batch_240.json');
const OUT = path.join(__dirname, '..', '.audit', 'DV-CRZ-SUMS_batch_240_result.json');
