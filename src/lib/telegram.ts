...
import { isRpvsExempt } from './rpvs-exempt';

// Re-export čistej funkcie kvôli spätnej kompatibilite starých importov.
// Klientske komponenty ju však importujú priamo z '@/lib/rpvs-exempt', aby si
// cez tento (Node-only, node-fetch) modul neťahali fetch-blob do bundle.
export { isRpvsExempt };
