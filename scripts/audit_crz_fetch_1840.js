#!/usr/bin/env node
// Audit DV-CRZ-SUMS batch 1840: dump 80 CRZ_CONTRACT rows (read-only), fetch CRZ detail pages,
...
const OUT_BATCH = path.join(__dirname, '..', '.audit', 'DV-CRZ-SUMS_batch_1840.json');
const OUT_RESULT = path.join(__dirname, '..', '.audit', 'DV-CRZ-SUMS_batch_1840_result.json');
