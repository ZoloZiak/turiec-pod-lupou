    ...
    <div className="min-h-screen bg-surface text-body font-sans p-4 sm:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          <Link
            href="/"
            className="text-muted hover:text-body transition-colors p-2 bg-card rounded-full shadow-sm border border-line"
            aria-label="Späť na dashboard"
          >
            <ArrowLeft className="w-5 h-5" aria-hidden="true" />
          </Link>
          <h1 className="text-2xl sm:text-3xl font-bold text-body flex items-center gap-2">
        ...
        {/* Perex */}
        <div className="bg-card rounded-2xl shadow-sm border border-line p-6 mb-6">
          ...
          <p className="text-sm text-muted mt-4 border-t border-line pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-900 rounded-2xl p-6">
          ...
          <div className="bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-900 rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-3">
              <AlertTriangle
        ...
        <p className="text-xs text-muted italic mb-8 px-1">
        ...
        <SectionTitle
          ...
          title="Čo je overené"
        />
        <div className="bg-card rounded-2xl shadow-sm border border-line divide-y divide-line mb-8">
          <Fact
        ...
        {/* 3. Čo treba zamerať */}
        <SectionTitle
          icon={<Ruler className="w-6 h-6 text-muted" />}
          title="Čo musí potvrdiť geodet a správca toku"
        />
        <div className="bg-elevated rounded-2xl border border-line p-6 mb-8">
        ...
        {/* 4. Referenčné mestá */}
        <SectionTitle
          icon={<MapPin className="w-6 h-6 text-muted" />}
        ...
        <div className="bg-card rounded-2xl shadow-sm border border-line p-6 mb-8">
          <div className="flex items-center gap-2 mb-3">
        ...
        {/* Zdroje */}
        <SectionTitle
          icon={<ExternalLink className="w-6 h-6 text-muted" />}
          title="Zdroje"
        />
        <div className="bg-card rounded-2xl shadow-sm border border-line p-6 mb-8 text-sm text-muted space-y-2">
...
function SectionTitle({
  ...
  return (
    <div className="flex items-center gap-2 mb-4 px-1">
      {icon}
      <h2 className="text-xl font-bold text-body">{title}</h2>
    </div>
  );
}
  ...
  return (
    <div className="p-6">
      <div className="flex items-start gap-3">
        ...
        />
        <div>
          <h3 className="font-bold text-body">{label}</h3>
          <p className="text-muted mt-1 leading-relaxed">{body}</p>
          <p className="text-xs text-muted mt-2">Zdroj: {src}</p>
        </div>
      </div>
    </div>
  );
...
function TodoItem({ body }: { body: string }) {
  return (
    <li className="flex items-start gap-3">
      <Ruler className="w-4 h-4 text-muted mt-1 shrink-0" aria-hidden="true" />
...
function RefCard({
  ...
  return (
    <div className={`bg-card rounded-xl border ${border} p-5 shadow-sm`}>
      <h3 className="font-bold text-body mb-2">{city}</h3>
